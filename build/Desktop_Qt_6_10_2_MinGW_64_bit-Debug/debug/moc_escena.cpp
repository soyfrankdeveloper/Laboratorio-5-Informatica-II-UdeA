...
template <> constexpr inline auto Escena::qt_create_metaobjectdata<qt_meta_tag_ZN6EscenaE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Escena, qt_meta_tag_ZN6EscenaE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Escena::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6EscenaE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6EscenaE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6EscenaE_t>.metaTypes,
    nullptr
} };
...
void *Escena::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6EscenaE_t>.strings))
